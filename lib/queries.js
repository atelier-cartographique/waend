...
module.exports = function (prefix, schema) {
    ...
    function geometricSQLLoadPart (tname) {
        return "SELECT id, layer_id, user_id, properties, ST_AsGeoJSON(geom) as geom FROM " + tableName(tname) +' ORDER BY id LIMIT $2 OFFSET $1 ;';
    }
    ...
    var queries = {
        ...
        layerLoadPart: {
            params: ['offset', 'limit'],
            sql: "SELECT id, user_id, properties FROM " + tableName('layers') +' ORDER BY id LIMIT $2 OFFSET $1;'
        },
        layerGet: {
            params: ['id'],
        ...
        compositionLoadPart: {
            params: ['offset', 'limit'],
            sql: "SELECT id, layer_id, group_id FROM " + tableName('compositions') +' ORDER BY id LIMIT $2 OFFSET $1;'
        },
        ...
        compositionDelete: {
            ...
            sql: "DELETE FROM " + tableName('compositions') + "  WHERE  group_id = $1 AND layer_id = $2;"
        },
        ...
        groupLoadPart: {
            params: ['offset', 'limit'],
            sql: "SELECT id, user_id, status_flag, properties FROM " + tableName('groups') +' ORDER BY id LIMIT $2 OFFSET $1;'
        },
        groupGet: {
            params: ['id'],

...
module.exports = function (prefix, schema) {
    ...
    var queries = {
        ...
        layerLoad: {
            params: [],
            sql: "SELECT id, user_id, type, properties FROM " + tableName('layers') +' ;'
        },
        layerUpdate: {
            params: ['id', 'user_id', 'type', 'properties'],
            sql: "UPDATE " + tableName('layers') + " SET (id, user_id, type, properties) = ($1, $2, $3, $4) WHERE id = $1 RETURNING *;"
        },
        layerCreate: {
            params: ['id', 'user_id', 'type', 'properties'],
            sql: "INSERT INTO " + tableName('layers') + " (id, user_id, type, properties) VALUES ($1, $2, $3, $4) RETURNING *;"
        },
        ...
        compositionCreate: {
            params: ['id', 'layer_id', 'group_id', 'sort_order'],
            sql: "INSERT INTO " + tableName('compositions') + " (id, layer_id, group_id) VALUES ($1, $2, $3) RETURNING *;"
        },
        compositionDelete: {
            params: ['id', 'layer_id', 'group_id'],
            sql: "DELETE FROM " + tableName('compositions') + "  WHERE id = $1 AND layer_id = $2 AND group_id = $3;"
        },

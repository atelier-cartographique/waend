...
module.exports = function (prefix, schema) {
    ...
    function geometricSQLLoadPart (tname) {
        return "SELECT id, layer_id, user_id, properties, ST_AsGeoJSON(geom) as geom FROM " + tableName(tname) +' LIMIT $2 OFFSET $1 ;';
    }
    ...
    var queries = {
        ...
        layerLoadPart: {
            params: ['offset', 'limit'],
            sql: "SELECT id, user_id, properties FROM " + tableName('layers') +' LIMIT $2 OFFSET $1;'
        },
        layerGet: {
            params: ['id'],
        ...
        compositionLoadPart: {
            params: ['offset', 'limit'],
            sql: "SELECT id, layer_id, group_id FROM " + tableName('compositions') +' LIMIT $2 OFFSET $1;'
        },
        ...
        groupLoadPart: {
            params: ['offset', 'limit'],
            sql: "SELECT id, user_id, status_flag, properties FROM " + tableName('groups') +' LIMIT $2 OFFSET $1;'
        },
        groupGet: {
            params: ['id'],

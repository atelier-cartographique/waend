...
var _ = require('underscore'),
    config = require('../render-config'),
    Geometry = require('../app/lib/Geometry'),
    Canvas = require('canvas'),
    fs = require('fs');

var MEDIA_URL = config.server.mediaDir;
...
ImageLoader.prototype.load = function (coordinates, extentArray, options) {
    ...
    var complete = function () {
        ...
        console.log('image', sw[0], sw[1], imgWidth, imgHeight);
    ...
    img.src = fs.readFileSync(url + '/1024.png');
    // if (img.complete) {
    //     complete();
    // }
    // else {
...
Painter.prototype.startTexture = function (tid) {
    var mc = this.context.canvas,
        canvas = new Canvas(mc.width, mc.height);
